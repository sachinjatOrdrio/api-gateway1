...
const payment_rpc_service_1 = require("./payment.rpc.service");
const message_patterns_enum_1 = require("./enums/message-patterns.enum");
let PaymentController = class PaymentController {
    constructor(paymentRpcService) {
...
], PaymentController.prototype, "ping", null);
exports.PaymentController = PaymentController = __decorate([
    (0, common_1.Controller)('payment'),
    __metadata("design:paramtypes", [payment_rpc_service_1.PaymentRpcService])
], PaymentController);
