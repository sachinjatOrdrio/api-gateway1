...
const shared_rpc_service_1 = require("./shared.rpc.service");
const message_patterns_enum_1 = require("./enums/message-patterns.enum");
let SharedController = class SharedController {
    constructor(sharedRpcService) {
        this.sharedRpcService = sharedRpcService;
    }
    ping() {
        try {
...
], SharedController.prototype, "ping", null);
exports.SharedController = SharedController = __decorate([
    (0, common_1.Controller)('shared'),
    __metadata("design:paramtypes", [shared_rpc_service_1.SharedRpcService])
], SharedController);
