...
export class StoresController {
  ...
  findAll() {
    try {
      return this.storesRpcService.sendRequest(
        MessagePatternEnum.GET_STORES,
        {},
      );
    } catch (error) {
      console.log(error);
  ...
  update(@Param('id') id: string, @Body() updateStoreDto: UpdateStoreDto) {
    try {
      return this.storesRpcService.sendRequest(
        MessagePatternEnum.UPDATE_STORE,
        { id, ...updateStoreDto },
      );
    } catch (error) {
      console.log(error);
  ...
  remove(@Param('id') id: string) {
    try {
      return this.storesRpcService.sendRequest(
        MessagePatternEnum.DELETE_STORE,
        id,
      );
    } catch (error) {
      console.log(error);
